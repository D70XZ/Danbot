...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:D70\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=5511964578978:+55 11964578978\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '.','!','#'
blocked = []
limitawal = '999999999'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD D70 BOT*',
					benned: 'Você para a banda, por favor, contate o proprietário para abrir sua banda',
					ownerG: '[❗] D70? Este é um recurso especial para o D70 ❌',
					ownerB: '[❗] D70? Este é um recurso especial para o D70 ❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de D70. Registre-se para fazer amizade com o bot D70 por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar D70|17\n\n──「 D70 BOT 」──`,
			...
			const ownerNumber = ["5511964578978@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"5511964578978@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["5511964578978@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["5511964578978@s.whatsapp.net"]//ubah nomor lo
			const premium = ["5511964578978@s.whatsapp.net","558296156440@s.whatsapp.net"] 
	...
	if (messagesC.includes("fdp")){
		...
		if (messagesC.includes("bot")){
            ...
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
				...
				if (messagesC.includes("D70")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/D70f.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOS D70 BOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @Danilogatin domina vida
          ...
          reply('Espere..')
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT D70 ✨* 」\n*│+ wa.me/5547992091566*╰──────*「 *D70* 」*────*\n\n*_SE QUER SER ADMIN DO BOT D70_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				if (!isUser) return reply(mess.only.userB)
					...
					client.sendMessage(from, sa, image, { quoted: mek, caption: '*╭────*「 *PREMIUM USER👑* 」\n*│+ wa.me/5511964578978/*╰──────*「 * D70* 」*────*\n\n*_SE QUER SER UM USUÁRIO PREMIUM DO D70 BOT_*\n*_Ketik #daftarvip*' })
					break
					case 'cekmod': 
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do D70:*\n\n https://youtube.com/channel/UCpB3qh2Sp3K23s9a2Q-Gf-g'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
